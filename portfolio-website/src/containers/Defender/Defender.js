                ...
                <div className={AnswerStyle.join(' ')}>
                    ...
                    <div className={classes.Content}>
                        <div className={classes.Section}>
                            ...
                            <span>This aspect shows how we interact with our surroundings:</span>
                        ...
                        <div className={classes.Section}>
                            ...
                            <span>The second aspect determines how we see the world and process information:</span>
                            <div className={classes.Container}>
                        ...
                        <div className={classes.Section}>
                            ...
                            <span>This aspect determines how we make decisions and cope with emotions:</span>
                            <div className={classes.Container}>
                        ...
                        <div className={classes.Section}>
                            ...
                            <span>This aspect reflects our approach to work, planning and decision-making:</span>
                            <div className={classes.Container}>
                        ...
                        <div className={classes.Section}>
                            ...
                            <span>Finally, the Identity aspect underpins all others, showing how confident we are in our abilities and decisions:</span>
                            <div className={classes.Container}>
