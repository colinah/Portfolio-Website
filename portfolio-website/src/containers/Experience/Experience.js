                ...
                <div className={classes.Content}>
                    ...
                    <div className={classes.Section}>
                        ...
                        <div className={classes.Text}>
                            ...
                            <div className={classes.Visit}><a href="https://ascendpnr.com" target="_blank" rel="noopener noreferrer">Visit AscendPnR</a></div>
                        </div>
                    </div> {/* Section */}
                    ...
                    <div className={classes.Section} >
                        <div className={[classes.Text, classes.Reverse].join(' ')}>
                            ...
                            <div className={classes.Visit}><a href="https://helixcreations.com" target="_blank" rel="noopener noreferrer">Visit Helix Creations</a></div>
                        </div>
                        <div className={classes.Image}>
                    ...
                    <div className={classes.Section}>
                        ...
                        <div className={classes.Text}>
                            ...
                            <div className={classes.Visit}><a href="https://helixcreations.com" target="_blank" rel="noopener noreferrer">Visit Helix Construction Co</a></div>
                        </div>
                    </div> {/* Section */}
